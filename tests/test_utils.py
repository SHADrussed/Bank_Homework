...
def test_get_list_dict_transactions_abs():
    assert get_list_dict_transactions('D:\PythonProjects\Bank_Homework\data\operations.json') == expected

def test_get_list_dict_transactions_dir():
    assert get_list_dict_transactions('data/operations.json') == expected

def test_get_list_dict_transactions_error():
    assert get_list_dict_transactions('') == []