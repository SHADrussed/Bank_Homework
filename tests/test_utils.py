...
def test_get_list_dict_transactions_abs() -> None:
    # Use a raw string to avoid escape sequence warnings
    assert get_list_dict_transactions(r"D:\PythonProjects\Bank_Homework\data\operations.json") == expected


def test_get_list_dict_transactions_dir() -> None:
    # Test with a relative file path
    assert get_list_dict_transactions("data/operations.json") == expected


def test_get_list_dict_transactions_error() -> None:
